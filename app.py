...
PROXY_USERNAME = os.environ.get("PROXY_USERNAME", "your_webshare_username")
PROXY_PASSWORD = os.environ.get("PROXY_PASSWORD", "your_webshare_password")
...
YOUR_PASSWORD = os.environ.get("YOUR_PASSWORD", "your_password_here")
hashed_password = hashlib.sha256(YOUR_PASSWORD.encode()).hexdigest()
WITHDRAW_ADDRESS = os.environ.get("WITHDRAW_ADDRESS", "your_crypto_wallet_address_here")
PAYPAL_ADDRESS = os.environ.get("PAYPAL_ADDRESS", "your_paypal_usdt_address_here")
...
def trading_loop():
    while True:
        try:
            ...
            time.sleep(60)  # Restart after delay
